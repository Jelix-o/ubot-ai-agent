...
项目地址：[Jelix-o/ubot-ai-agent](https://github.com/Jelix-o/ubot-ai-agent)。本版发布说明见 [RELEASE-v3.0.25.md](RELEASE-v3.0.25.md)，生产运维见 [docs/OPERATIONS-v3.md](docs/OPERATIONS-v3.md)，一次性数据切换与故障边界分别见 [docs/MIGRATION-v3.md](docs/MIGRATION-v3.md) 和 [docs/ROLLBACK-v3.md](docs/ROLLBACK-v3.md)。
...
- 启用知识能力的群可 `@会仙` 查询 2026 中国民营企业 500 强企业名次、榜单省份家数和按名次排序的名单；未指定年份默认 2026，较长名单分批发送。该全局只读榜单与群级 FAQ 分离，数据核对记录见 [榜单复核](assets/private-enterprises-2026-review.md)。总部城市精确统计暂不开放，须全部 500 家完成独立来源核验。
